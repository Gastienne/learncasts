...
module.exports = {
  ...
  async onPreBuild({
    ...
    try {
      ...
      const urlToSplit: string[] =  process.env.DEPLOY_URL.split('/')
      const urlDeployPreview: String = urlToSplit[1].split('-')
      const idDeployPreview: String = urlDeployPreview[1]
      console.log(idDeployPreview)
    } catch (error) {
      // Report a user error
